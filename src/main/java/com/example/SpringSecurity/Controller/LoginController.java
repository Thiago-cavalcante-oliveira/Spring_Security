...
public class LoginController {
    ...
    public ResponseEntity<UsuarioDTO> findById(@RequestParam final Long id){
        try {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Erro: " + e.getMessage(), e);
        }
    }
    ...
    @PutMapping
    public ResponseEntity<String> update(@RequestParam Long id ,@RequestBody @Validated final UsuarioDTO usuarioDTO){
        try {
